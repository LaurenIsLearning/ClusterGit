...
export default function ConfirmationModal({
    ...
    return createPortal(
        <div className="fixed inset-0 z-[60] flex items-center justify-center overlay-scrim animate-fade-in p-4">
            <div className="modal-panel w-full max-w-sm rounded-2xl p-6 scale-in-center">
